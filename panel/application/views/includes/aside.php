    ...
    <div class="media">
      <div class="media-left">
        <div class="avatar avatar-md avatar-circle">
          <a href="javascript:void(0)"><img class="img-responsive" src="<?php echo base_url("assets"); ?>/assets/images/dogukantekin.jpeg" alt="avatar"/></a>
        </div><!-- .avatar -->
      </div>
      <div class="media-body">
        <div class="foldable">
          <h5><a href="javascript:void(0)" class="username">Doğukan TEKİN</a></h5>
          <ul>
            <li class="dropdown">
  ...
  <div class="menubar-scroll">
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li>
          <a href="javascript:void(0)">
            <i class="menu-icon fa fa-cubes zmdi-hc-lg"></i>
        ...
        <li>
          <a href="javascript:void(0)">
            <i class="menu-icon fa fa-newspaper-o zmdi-hc-lg"></i>
        ...
        <li>
          <a href="javascript:void(0)">
            <i class="menu-icon fa fa-user-secret zmdi-hc-lg"></i>
